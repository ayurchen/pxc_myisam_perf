...
RUN_TEST="sysbench --test=sysbench_tests/db/update_index.lua --mysql-user=root --mysql-db=test --oltp-table-size=1000000 --max-requests=0 --max-time=600 --num-threads=16 --report-interval=1 run"
